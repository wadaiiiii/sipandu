...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/action-feedback.ts', 'resources/js/app.tsx', 'resources/js/ux-performance.ts', 'resources/js/class-card-loading-guard.ts', 'resources/js/student-progress.tsx', 'resources/js/pwa-controls.tsx', 'resources/js/calendar-panel.tsx', 'resources/js/class-access-panel.tsx', 'resources/js/class-code-editor.ts', 'resources/js/lecturer-join-dashboard.ts', 'resources/js/header-utilities.ts', 'resources/js/ui-polish.ts', 'resources/js/ui-language.ts'])
    <style>
