...
<head>
    ...
    <script>
        (() => {
            ...
            ["sipandu-account-security.js","sipandu-dashboard-reliability.js","sipandu-dashboard-insights.js","sipandu-unsulbar-brand.js","sipandu-onboarding.js"].forEach((name) => {
