...
async function storeMaterialWithAttachment(form: HTMLFormElement, file: File): Promise<void> {
    ...
    try {
        ...
        const response = await fetch(`/api/classes/${classId}/meetings/${meeting.value}/materials`, {
...
async function fetchResources(): Promise<void> {
    ...
    try {
        const response = await fetch(`/api/classes/${classId}/material-resources`, { credentials: 'include', headers: { Accept: 'application/json' } });
